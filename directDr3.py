...
for file in os.listdir('/ll4/data/4/animal/20220708_awakeGIMRI/processed/'):
    if re.match('.*gz',file):
        print(file)
        data=get_nii_data(os.path.join('/ll4/data/4/animal/20220708_awakeGIMRI/processed/',file))
        #data=get_data()
        foldername=os.path.splitext(os.path.splitext(file)[0])[0]
        pathname=os.path.join('20220708_awakeGIMRI',foldername)
